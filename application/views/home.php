            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        ...
                        <hr class="light">
                        <p class="text-faded">I'm Sachith Ushan an undergraduate of University of Westminster. Enjoy my quiz made specially for you to spend your leisure time.</p>
                    </div>
                </div>
            </div>
        </section>

        <section id="signin" class="bg-dark">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="password"/><br><br>
                            <a href="#" class="btn btn-primary btn-xl page-scroll">Sign In</a>
                        </div>
                    </div>
                    <div class="col-lg-3">
