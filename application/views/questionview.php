            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="adminView.html">View category</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#category">Add new question</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#category">Manage question</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
                    ...
                    <section class="no-padding" id="portfolio">
                        <div class="container-fluid">
                            ...
                            <div class="row no-gutter text-left">
                                <p data-toggle="collapse" data-target="#editdiv1">Quesion 1</p>
                                <div id='editdiv1' class="collapse">
                                    me tama mada kalla
                                </div>
                                <p data-toggle="collapse" data-target="#editdiv2">Quesion 2</p>
                                <div id='editdiv2' class="collapse">
                                    me tama mada kalla
                                </div>
                                <p>Quesion 1</p>
                                <p>Quesion 1</p>
